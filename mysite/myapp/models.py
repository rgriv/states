...
class Input(models.Model):
    ...
    state9 = models.CharField(max_length = 50, choices = STATES)
    state10 = models.CharField(max_length = 50, choices = STATES)
    ...
    data9 = models.CharField(max_length = 50, choices = DATA)
    data10 = models.CharField(max_length = 50, choices = DATA)
